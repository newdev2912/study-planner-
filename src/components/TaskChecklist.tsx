import { Zap, CheckCircle2, Plus, Trash2, AlertCircle } from 'lucide-react';
...
export const TaskChecklist = ({ 
  ...
  return (
    <GlowCard glowColor="emerald" className="h-full border-emerald-500/20">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="p-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-lg text-emerald-400 hover:bg-emerald-500/20 transition-all"
          >
            <Plus className="w-4 h-4" />
          </button>
          <button onClick={() => setView('planner')} className="text-[10px] font-black text-emerald-400 uppercase tracking-widest hover:underline">View All</button>
        </div>
      </div>
            ...
            <motion.div 
              ...
              className={cn(
                ...
                task.completed 
                  ...
                  : "bg-slate-950/40 border-slate-800/50 hover:border-emerald-500/30"
              )}
            >
              <button 
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <input 
                    ...
                    className="text-[8px] font-black text-emerald-400 uppercase tracking-tighter px-1.5 py-0.5 bg-emerald-500/10 rounded bg-transparent border-none focus:ring-0 w-20"
                  />
